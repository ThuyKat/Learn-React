...
export default function UseReducerExample(){
    ...
    return (<div>
        {
            state?.showTextFlag? <h3 style={{backgroundColor: state?.changeTextStylesFlag? "black":"red"}}>Use Reducer Hook Example</h3> : null
        }
        
        {/* the object inside dispatch is action object */}
